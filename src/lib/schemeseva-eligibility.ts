 ...
 */
export function checkEligibility(scheme: Scheme, profile: CitizenProfile): EligibilityResult {
  ...
  if ((rules.minAge != null || rules.maxAge != null) && profile.age != null && !hardFail) {
  ...
  if (
    ...
    reasons.push(
      `Landholding ${profile.landAcres} acres is within the ${rules.maxLandAcres} acre limit.`,
    );
  }
