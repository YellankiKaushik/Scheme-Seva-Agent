        ...
        <div className="mx-auto max-w-6xl px-4 py-20 sm:py-28">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-6 text-lg leading-relaxed text-muted-foreground sm:text-xl">
              India runs 1,000+ welfare schemes. Most eligible citizens never claim them because
              discovery is broken. SchemeSeva is a civic AI agent that finds what you qualify for —
              and keeps watching, so you never miss a new benefit.
            </p>
      ...
      <section className="border-y border-border/60 bg-parchment/40 py-20">
        <div className="mx-auto max-w-5xl px-4">
          ...
          <p className="mt-4 max-w-3xl text-lg text-muted-foreground">
            Research on PM-JAY confirms: the barrier isn't that schemes don't exist — it's that
            eligible citizens don't know they qualify. Existing portals like myScheme fail in four
            structural ways.
          </p>
        ...
        <div className="mx-auto max-w-6xl px-4">
          <div className="max-w-3xl">
            ...
            <p className="mt-3 text-lg text-muted-foreground">
              Orchestrated to think, retrieve, remember, evaluate, and act — the five agentic verbs
              judged by the hackathon.
            </p>
          </div>
            ...
            {[
              ...
              >
                <div className="flex items-center justify-between">
                  <span className="font-display text-2xl font-semibold text-accent">{a.n}</span>
                  <span className="rounded-full bg-primary/10 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wider text-primary">
                    {a.verb}
                  </span>
                </div>
                <h3 className="mt-3 font-display text-lg font-semibold text-primary">{a.name}</h3>
        ...
        <div className="mx-auto grid max-w-6xl gap-12 px-4 md:grid-cols-2 md:items-center">
          <div>
            ...
            <p className="mt-4 text-lg text-muted-foreground">
              AI in the government sector carries risks of hallucination and bias. Every SchemeSeva
              report is validated by an AI safety layer before it reaches you.
            </p>
          ...
          <div className="rounded-2xl border border-border bg-card p-8 shadow-sm">
            ...
            <p className="mt-3 text-sm text-muted-foreground">
              You likely qualify because you're a Telangana farmer with a pattadar passbook and a
              linked bank account.
            </p>
