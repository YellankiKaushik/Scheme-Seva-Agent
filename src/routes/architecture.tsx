...
const layers = [
  {
    l: "Frontend",
    t: "TanStack Start (React 19) + Tailwind v4",
    p: "Landing, agent runner, results, browse, and alert banner.",
  },
  {
    l: "Orchestration",
    t: "Mastra-style pipeline in TypeScript server functions",
    p: "Chains 5 agents. Each step is a typed server function, testable in isolation.",
  },
  {
    l: "LLM reasoning",
    t: "OpenRouter",
    p: "Profile extraction and report generation, with local grounded fallback in demo mode.",
  },
  {
    l: "Embeddings",
    t: "Google Gemini embeddings",
    p: "Semantic vectors for Qdrant retrieval when GEMINI_API_KEY is configured.",
  },
  {
    l: "Retrieval",
    t: "Qdrant + local catalog fallback",
    p: "Verified schemes indexed with eligibility rules, keywords, and metadata.",
  },
  {
    l: "Memory",
    t: "Qdrant citizen_sessions + local session fallback",
    p: "Citizen profile + found schemes persisted by browser-generated session key.",
  },
  {
    l: "Safety",
    t: "Enkrypt AI + OpenRouter fallback",
    p: "Every citizen-facing report checked before display.",
  },
  {
    l: "Autonomous",
    t: "Vigilance Agent · Simulate button",
    p: "Scans saved profile against new schemes without being asked.",
  },
];
...
const agents = [
  {
    n: "1. Profile Agent",
    verb: "think",
    d: "Extracts state, age, gender, category, income, occupation, land, disability from free text. Sets missing fields to null. Asks one follow-up if a critical field is missing.",
  },
  {
    n: "2. Discovery Agent",
    verb: "retrieve",
    d: "Multi-angle keyword + attribute scoring against 28 schemes. Boosts occupation and state matches. Returns top 20 unique candidates.",
  },
  {
    n: "3. Eligibility Agent",
    verb: "evaluate",
    d: "Deterministic rule check: age, gender, category, income cap, occupation, state, Aadhaar, bank. Hard-fail excludes. Missing docs → medium confidence.",
  },
  {
    n: "4. Report Agent",
    verb: "communicate",
    d: "8th-grade markdown report. Sorted by confidence. 'Likely eligible' throughout. Source URL and last-verified date on every scheme. One disclaimer at the end.",
  },
  {
    n: "5. Vigilance Agent",
    verb: "act",
    d: "Autonomous. Fetches all citizen sessions, scans schemes the citizen hasn't seen, fires alerts for matches above the confidence threshold. Simulate button demos it in <5s.",
  },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-5xl px-4 py-16">
        ...
        <p className="mt-4 max-w-3xl text-lg text-muted-foreground">
          SchemeSeva is a TypeScript-native civic AI agent built on the final hackathon stack:
          Mastra adapter orchestration, Qdrant semantic retrieval, Google embeddings, OpenRouter
          reasoning, and Enkrypt AI safety validation.
        </p>
