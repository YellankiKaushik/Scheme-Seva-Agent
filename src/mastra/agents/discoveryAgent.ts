...
export const discoveryAgent = {
    name: "DiscoveryAgent",
    description:
        "Generates occupation, income, category, state, and gender/special-status semantic query angles; retrieves and deduplicates top 20 schemes from Qdrant or Supabase fallback.",
